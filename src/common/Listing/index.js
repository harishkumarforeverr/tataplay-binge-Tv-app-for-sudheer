                                ...
                                >
                                  <div>
                                    <span class="listing-block">
                                      ...
                                      >
                                        <div className="shuffleCardContainer">
                                          <div className="shuffleCardContainer innerCard_two">
                                            <div className="shuffleCardContainer innerCard_three">
                                              <div className="shuffleCardContainer innerCard_four">
                                                <div>
                                                  <div className="shuffleCard_content">
                                                    <img
                                                  ...
                                                  <div>
                                                    <span className="shuffleCard_text">
                                                      Shuffle
                                                    </span>
                                                    <span className="shuffleCard_text">
                                                      Content
