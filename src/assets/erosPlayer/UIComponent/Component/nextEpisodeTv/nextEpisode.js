 ...
 */
function logituitButtonnextEpisodeTvComponent() {
    // var Button = videojs.getComponent('Button');
    this.duration = new logituitDurationComponent();
    this.durationObj = this.duration;
    var me;
    this.nextEpisodeButtonTv = videojs.extend(videojs.getComponent('Button'), {
      constructor: function(player,option, uiEngine) {
       ...
       this.elementRef = videojs.dom.createEl('button', {
         className:'logituit_nextEpisodeButtonTv'
       });
    ...
    releaseResource: function() {
      ...
      if (this.elementRef) {
        ...
        delete this.nextEpisodeButtonTv;
        this.nextEpisodeButtonTv = null;
      }
      }
    });
    videojs.registerComponent('liveButton', this.nextEpisodeButtonTv);
    }
