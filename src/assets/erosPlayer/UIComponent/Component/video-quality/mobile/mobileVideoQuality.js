function logituitMobileVideoQualityPopup() {
    var me;
    this.mobileVideoQuality = videojs.extend(videojs.getComponent('ClickableComponent'), {
        constructor: function (player, options, wrapper, baseOptions, uiEngine) {
            ...
            me.isPortrait = !me.uiEngine.isLandscape() && me.uiEngine.isMobile();
            me.isLandscape = me.uiEngine.isLandscape() && me.uiEngine.isMobile();
            this.el().setAttribute("class", "videoQualityChildPopup");

            let containerTitle = document.createElement("Label");
            containerTitle.innerHTML = "Video Quality";
            ...
            baseOptions.videoQualitySettings.forEach(function (element) {
                ...
                if (element.playback_ql_quality) {
                    quality.innerHTML = element.playback_ql_title + " Quality (" + element.playback_ql_quality + ")";
                } 
                else if(element.playback_ql_title == "Auto"){
                    quality.innerHTML = element.playback_ql_title;
                }
                else {
                    quality.innerHTML = element.playback_ql_title + " Quality (" + element.playback_ql_qualityMweb + ")";
                }
    ...
    videojs.registerComponent('mobileVideoQuality', this.mobileVideoQuality);
}